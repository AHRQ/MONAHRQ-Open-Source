...
,a.AIDHRD AS ReportedCNAStaffingHoursperResidentperDayNation
,a.VOCHRD AS ReportedLPNStaffingHoursperResidentperDayNation 
,a.RNHRD AS ReportedRNStaffingHoursperResidentperDayNation
,a.TOTLICHRD AS LicensedStaffingHoursperResidentperDayNation
,a.TOTHRD AS TotalNurseStaffingHoursperResidentperDayNation
,a.PTHRD AS PhysicalTherapistStaffingHoursperResidentPerDayNation
,a.C1_HLTH_DEFS_CNT AS TotalHealthDeficienciesNation 
,a.C1_FS_DEFS_CNT AS TotalFireSafetyDeficienciesNation 




,L.AIDHRDState AS ReportedCNAStaffingHoursperResidentperDayState
,L.VOCHRDState AS ReportedLPNStaffingHoursperResidentperDayState 
,L.RNHRDState AS ReportedRNStaffingHoursperResidentperDayState
,L.TOTLICHRDState AS LicensedStaffingHoursperResidentperDayState
,L.TOTHRDState AS TotalNurseStaffingHoursperResidentperDayState
,L.PTHRDState AS PhysicalTherapistStaffingHoursperResidentPerDayState
,L.C1_HLTH_DEFS_CNTState AS TotalHealthDeficienciesState 
,L.C1_FS_DEFS_CNTState AS TotalFireSafetyDeficienciesState 
...
,Z.AIDHRD as AIDHRDState
,Z.VOCHRD AS VOCHRDState
,Z.RNHRD AS RNHRDState
,Z.TOTLICHRD AS TOTLICHRDState
,Z.TOTHRD AS TOTHRDState  
,Z.PTHRD AS PTHRDState

,Z.C1_HLTH_DEFS_CNT AS C1_HLTH_DEFS_CNTState 
,Z.C1_FS_DEFS_CNT AS C1_FS_DEFS_CNTState 
