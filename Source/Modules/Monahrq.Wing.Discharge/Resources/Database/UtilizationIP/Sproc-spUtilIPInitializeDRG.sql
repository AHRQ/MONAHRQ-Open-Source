...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilIPInitializeDRG' 
)
   DROP PROCEDURE dbo.spUtilIPInitializeDRG
GO

CREATE PROCEDURE dbo.spUtilIPInitializeDRG
