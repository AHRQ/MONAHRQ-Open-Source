...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilIPInitializeMDC' 
)
   DROP PROCEDURE dbo.spUtilIPInitializeMDC
GO

CREATE PROCEDURE dbo.spUtilIPInitializeMDC
