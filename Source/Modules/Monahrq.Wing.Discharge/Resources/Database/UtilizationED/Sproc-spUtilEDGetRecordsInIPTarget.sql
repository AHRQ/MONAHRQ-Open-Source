/*
 *      Name:           spUtilEDGetRecordsInIPTarget
...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilEDGetRecordsInIPTarget' 
)
   DROP PROCEDURE dbo.spUtilEDGetRecordsInIPTarget
GO

CREATE PROCEDURE dbo.spUtilEDGetRecordsInIPTarget
