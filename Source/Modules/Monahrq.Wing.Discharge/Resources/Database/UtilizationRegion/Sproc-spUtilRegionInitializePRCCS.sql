/*
 *      Name:           spUtilRegionInitializePRCCS
...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilRegionInitializePRCCS' 
)
   DROP PROCEDURE dbo.spUtilRegionInitializePRCCS
GO

CREATE PROCEDURE dbo.spUtilRegionInitializePRCCS
