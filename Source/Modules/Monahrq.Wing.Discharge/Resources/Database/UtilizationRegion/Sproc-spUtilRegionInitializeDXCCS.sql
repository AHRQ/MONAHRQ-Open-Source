/*
 *      Name:           spUtilRegionInitializeDXCCS
...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilRegionInitializeDXCCS' 
)
   DROP PROCEDURE dbo.spUtilRegionInitializeDXCCS
GO

CREATE PROCEDURE dbo.spUtilRegionInitializeDXCCS
