/*
 *      Name:           spUtilRegionGetRecordsInIPTarget
...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilRegionGetRecordsInIPTarget' 
)
   DROP PROCEDURE dbo.spUtilRegionGetRecordsInIPTarget
GO

CREATE PROCEDURE dbo.spUtilRegionGetRecordsInIPTarget
