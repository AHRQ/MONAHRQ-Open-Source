/*
 *      Name:           spUtilCountyInitializeDRG
...
IF EXISTS (
	...
	WHERE SPECIFIC_SCHEMA = N'dbo' AND SPECIFIC_NAME = N'spUtilCountyInitializeDRG' 
)
   DROP PROCEDURE dbo.spUtilCountyInitializeDRG
GO

CREATE PROCEDURE dbo.spUtilCountyInitializeDRG
