...
{
    /// <summary>
    /// View model class for wizard file view
    /// </summary>
    /// <seealso cref="Monahrq.Theme.Controls.Wizard.Models.WizardStepViewModelBase{Monahrq.Wing.Dynamic.Models.WizardContext}" />
    [ImplementPropertyChanged]
    public class FullWizardFileReadabilityViewModel :
        WizardStepViewModelBase<WizardContext>
    {
        /// <summary>
        /// Event handler to notify the progress.
        /// </summary>
        public event EventHandler<ExtendedEventArgs<Action>> NotifyProgress = delegate { };
        /// <summary>
        /// Occurs when file is verified.
        /// </summary>
        public event EventHandler Verified = delegate { };
        /// <summary>
        /// Occurs when file readability is failed.
        /// </summary>
        public event EventHandler Failed = delegate { };

        /// <summary>
        /// Initializes a new instance of the <see cref="FullWizardFileReadabilityViewModel"/> class.
        /// </summary>
        /// <param name="dataContext">The data context.</param>
        public FullWizardFileReadabilityViewModel(WizardContext dataContext)
            : base(dataContext)
        {
            ...
            using (var conn = Dataservices.ConnectionFactory())
            {
                try
                {
                    using (var cmd = Dataservices.Controller.ProviderFactory.CreateCommand())
                    {
                        ...
                        {
                            var arry = new object[histogram.FieldCount];
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="FullWizardFileReadabilityViewModel"/> is cancelled.
        /// </summary>
        /// <value>
        ...
        public string CurrentFile
        {
            get
            {
                var ds = Dataservices ?? DataContextObject.Services;
