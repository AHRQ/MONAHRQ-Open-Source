...
/*    'monahrq.products.consumer.physicians.domain'*/
  ...
  function config($stateProvider) {
    ...
    $stateProvider.state('top.consumer.physicians.search', {
      ...
      views: {
       'content@': {
         templateUrl: 'app/products/mobile/physicians/views/search.html',
    ...
    $stateProvider.state('top.consumer.physicians.profile', {
      ...
      views: {
        'content@': {
          templateUrl: 'app/products/mobile/physicians/views/profile.html',
        ...
        'physician-profile-location@top.consumer.physicians.profile': {
          templateUrl: 'app/products/mobile/physicians/views/profile_location.html'
        },
