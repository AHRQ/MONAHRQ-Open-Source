...
(function () {
    ...
    PProfileCtrl.$inject = ['$scope', '$state', '$stateParams', '$q', 'ResourceSvc', 'PhysicianAPISvc', 'PhysicianReportLoaderSvc',
      ...
      'ModalTopicCategorySvc', 'ModalTopicSvc', 'ModalMeasureSvc', 'ModalGenericSvc', 'ReportConfigSvc', 'ModalFeedbackSvc', 'deviceDetector'];
    function PProfileCtrl($scope, $state, $stateParams, $q, ResourceSvc, PhysicianAPISvc, PhysicianReportLoaderSvc,
        ...
        $scope.allTopics = [];
        $scope.physicianMGButton = "Hide Ratings";

        $scope.toggleButtonText = toggleButtonText;
        $scope.search = search;
        ...
        function numPractices() {
            if ($scope.physicianData != null && $scope.physicianData.practices != null)
        ...
        function toggleButtonText(reportSettings) {
            reportSettings.showHedis = !reportSettings.showHedis;
            $scope.physicianMGButton = reportSettings.showHedis ? "Hide Ratings" : "Show Ratings";
        }
