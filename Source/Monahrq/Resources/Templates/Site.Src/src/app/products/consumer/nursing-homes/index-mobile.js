...
function config($stateProvider) {
  ...
  $stateProvider.state('top.consumer.nursing-homes', {
    ...
    $stateProvider.state('top.consumer.nursing-homes.location', {
        ...
        views: {
            'content@': {
                templateUrl: 'app/products/mobile/nursing-homes/views/location.html',
  ...
  $stateProvider.state('top.consumer.nursing-homes.profile', {
    ...
    views: {
      'content@': {
          templateUrl: 'app/products/mobile/nursing-homes/views/profile.html',
      ...
      'profile-tab1@top.consumer.nursing-homes.profile': {
          templateUrl: 'app/products/mobile/nursing-homes/views/profile_measures.html',
  ...
  $stateProvider.state('top.consumer.nursing-homes.infographic', {
    ...
    views: {
      'content@': {
        templateUrl: 'app/products/mobile/nursing-homes/views/infographic.html',
