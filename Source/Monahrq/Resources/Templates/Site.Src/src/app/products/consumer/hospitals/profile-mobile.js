...
(function() {
   ...
   */
    ...
    CHProfileCtrl.$inject = ['$scope', '$state', '$stateParams', 'HospitalRepositorySvc', 'CHReportSvc', 'ScrollToElSvc', 'ModalLegendSvc', 'ConsumerReportConfigSvc', 'ZipDistanceSvc', 'hospitalZips', 'zipDistances', 'ModalMeasureSvc', 'deviceDetector'];
    function CHProfileCtrl($scope, $state, $stateParams, HospitalRepositorySvc, CHReportSvc, ScrollToElSvc, ModalLegendSvc, ConsumerReportConfigSvc, ZipDistanceSvc, hospitalZips, zipDistances, ModalMeasureSvc, deviceDetector) {
    var id;
