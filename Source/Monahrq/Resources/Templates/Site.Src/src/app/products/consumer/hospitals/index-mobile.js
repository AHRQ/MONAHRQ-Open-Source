...
function config($stateProvider) {
    ...
    $stateProvider.state('top.consumer.hospitals.location', {
      ...
      views: {
        'content@': {
            templateUrl: 'app/products/mobile/hospitals/views/location.html',
    ...
    $stateProvider.state('top.consumer.hospitals.location-map', {
      ...
      views: {
        'content@': {
          templateUrl: 'app/products/mobile/hospitals/views/location_map.html',
    ...
    $stateProvider.state('top.consumer.hospitals.profile', {
      ...
      views: {
        'content@': {
          templateUrl: 'app/products/mobile/hospitals/views/profile.html',
        ...
        'profile-tab1@top.consumer.hospitals.profile': {
          templateUrl: 'app/products/mobile/hospitals/views/profile_quality_mobile.html',
        ...
        'profile-tab3@top.consumer.hospitals.profile': {
          templateUrl: 'app/products/consumer/hospitals/views/profile_physicians_mobile.html',
    ...
    $stateProvider.state('top.consumer.hospitals.infographic', {
      ...
      views: {
        'content@': {
          templateUrl: 'app/products/mobile/hospitals/views/infographic.html',
    ...
    $stateProvider.state('top.consumer.hospitals.health-topics', {
      ...
      views: {
        'content@': {
          templateUrl: 'app/products/mobile/hospitals/views/health_topics.html',
