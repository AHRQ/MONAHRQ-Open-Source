...
(function () {
    ...
    function config($stateProvider) {
        $stateProvider.state('top.consumer', {
            ...
            views: {
                'header@': {
                    templateUrl: 'app/products/mobile/pages/views/header.html',
                    controller: 'CHeaderCtrl'
                },
                'navigation@': {
                    templateUrl: 'app/products/mobile/pages/views/navigation.html',
                    controller: 'CNavigationCtrl'
                },
                'footer@': {
                    templateUrl: 'app/products/mobile/pages/views/footer.html',
        ...
        $stateProvider.state('top.consumer.home', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/products/mobile/pages/views/index.html',
        ...
        $stateProvider.state('top.consumer.profile-search', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/products/mobile/pages/views/profile_search.html',
        ...
        $stateProvider.state('top.consumer.about-ratings', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/products/mobile/pages/views/about-ratings.html',
        ...
        $stateProvider.state('top.consumer.resources', {
            url: '/resources/:page',
            data: {
                pageTitle: 'Resources'
            },
            views: {
                'content@': {
                    templateUrl: 'app/products/consumer/pages/views/about-quality-ratings-mobile.html',
                    controller: 'AboutRatingsCtrl',
                    resolve: {
                        content: function (ResourceSvc) {
                            return ResourceSvc.getpgResources();
        ...
        $stateProvider.state('top.consumer.infographic', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/products/mobile/pages/views/infographic.html',
