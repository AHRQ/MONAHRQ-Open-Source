...
{
    /// <summary>
    /// The custom rolling log appender for Log4net.
    /// </summary>
    /// <seealso cref="log4net.Appender.FileAppender" />
    public class CustomRollingAppender : FileAppender
    {
        //This class is excalty the same as log4net RollingFileAppender, it's minimally modified to log addtional information. 
        /// <summary>
        /// The start tag
        /// </summary>
        private static readonly string startTag = @"{\rtf1\ansi\deff0{\fontbl{\f0 \froman }}{\colortbl;\red0\green0\blue0;\red255\green127\blue39;\red255\green0\blue0;}" + System.Environment.NewLine;
        /// <summary>
        /// The end tag
        /// </summary>
        private static readonly string endTag = @"} " + System.Environment.NewLine;
        /// <summary>
        /// The object
        /// </summary>
        ...
        /// <list type="bullet"><item>determine curSizeRollBackups (only within the current roll point)</item><item>initiates a roll over if needed for crossing a date boundary since the last run.</item></list>
        /// </remarks>
        ...
        /// <param name="curFileName">Name of the current file.</param>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Invalid RollPoint, unable to parse [" + m_datePattern + "]</exception>
        /// <remarks>
        /// <para>
        ...
        /// </summary>
        /// <seealso cref="Monahrq.Sdk.Logging.CustomRollingAppender.IDateTime" />
        ...
        /// <summary>
        /// This method is empty for now since we are using html format for out log.
        /// </summary>
        protected void BuildRtfCompatible()
        {
            //lock (obj)
            //{
            //    if (!FileExists(File)) return;
            //    var tempFile = Path.GetTempFileName();
            //    StringBuilder logFileContent;
            ...
            //            logFileContent = new StringBuilder(startTag + text.Replace(startTag, "").Replace(endTag, "") + endTag);
