...
{
    /// <summary>
    /// The custom Nhibernate SqlVariant type.
    /// </summary>
    /// <seealso cref="NHibernate.UserTypes.IUserType" />
    public class SqlVariant : IUserType
	{
        /// <summary>
        /// The variant SQL type
        /// </summary>
        private readonly SqlType[] _variantSqlType = new SqlType[1] { new SqlType(DbType.Object) };
        ...
        public void NullSafeSet(IDbCommand cmd, object value, int index)
		{
			...
			var valueToSet = value ?? DBNull.Value;
