...
namespace Monahrq.Infrastructure.BaseDataLoader.Loaders
{
    ...
    public class HRRToPopulationStratsStrategy : BaseDataSqlBulkImporter<RegionPopulationStrats, int>
    {
        /// <summary>
        /// Gets the fileprefix.
        /// </summary>
        ...
        /// The fileprefix.
        /// </value>
        protected override string Fileprefix { get { return "HRRToPopulationStrats"; } }
        /// <summary>
        ...
        /// </value>
        public override bool AllowDisableIndexesDuringImport { get { return false; } }
