...
{
    /// <summary>
    /// The default wizard select file viewmodel.
    /// </summary>
    /// <seealso cref="Monahrq.Theme.Controls.Wizard.Models.WizardStepViewModelBase{Monahrq.DataSets.Model.DatasetContext}" />
    [Export]
    [ImplementPropertyChanged]
    public class DefaultWizardSelectFileViewModel : WizardStepViewModelBase<DatasetContext>
    {
        /// <summary>
        /// Gets the manager.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultWizardSelectFileViewModel" /> class.
        /// </summary>
        /// <param name="c">The c.</param>
        public DefaultWizardSelectFileViewModel(DatasetContext c)
            : base(c)
        {
        ...
        public override RouteModifier OnNext()
        {
            ...
            DataContextObject.HasHeader = DatasourceModel.ConnectionElement.HasHeader;
        ...
        /// <summary>
        /// Called when [mapping file upload].
        /// </summary>
