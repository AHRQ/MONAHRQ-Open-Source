    ...
    public class DefaultLinkNavigator: ILinkNavigator
    {
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            else
            {
                ...
                if (source == null)
                {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture,"Navigation Source not specified", uri));
                }
                ...
                if (frame == null)
                {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, "Navigation frame not found", uri, parameter));
                }
